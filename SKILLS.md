...
- [`langsmith`](data/tools/langsmith.yml) — detection/post_generation, surfaces: http_service, library; Hosted LLM observability, tracing, and evaluation platform.
...
- [`snyk`](data/tools/snyk.yml) — detection/post_generation, surfaces: cli, ci_app; Vulnerability scanning for code, dependencies, containers, and IaC.
...
- [`langsmith`](data/tools/langsmith.yml) — detection/post_generation, surfaces: http_service, library; Hosted LLM observability, tracing, and evaluation platform.
- [`smolagents`](data/tools/smolagents.yml) — detection/post_generation, surfaces: library; Minimalist code-agent library that expresses actions as executed Python.
...
- [`giskard`](data/tools/giskard.yml) — detection/post_generation, surfaces: library, cli, ci_app; Open-source evaluation and testing library for LLM agents and ML models.
...
- [`voltagent`](data/tools/voltagent.yml) — detection/post_generation, surfaces: library; TypeScript-native AI agent engineering platform with built-in observability.
